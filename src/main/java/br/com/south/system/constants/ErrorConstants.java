...
public class ErrorConstants {
    ...
    public static final String INFORMAR_ID_DA_PAUTA_ERROR = "Favor informar o id da pauta";
    public static final String PAUTA_NOT_FOUND_ERROR = "Não foi possivel encontrar uma pauta com o id: ";
